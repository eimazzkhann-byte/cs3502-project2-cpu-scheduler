...
Python console app for CS 3502 Project 2.

## Platform Tested On
Ubuntu running in Oracle VirtualBox on Windows 11
...
## Project Notes
This project was built from scratch as a Python console application. The assignment allows building from scratch in any language and allows a well-formatted console interface as long as the required scheduling functionality, metrics, comparison capability, and documentation are present.

## Files
- `main.py` - main menu and flow
- `models.py` - data classes
- `algorithms.py` - scheduling algorithms
- `metrics.py` - performance metric calculations
- `workloads.py` - built-in test workloads
